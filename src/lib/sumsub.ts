...
export class SumsubClient {
  ...
  constructor() {
    this.appToken = process.env.SUMSUB_APP_TOKEN || "sbx:TiHbApn3e2JDxVWgzfQhZgw6.sD1Wcl7C0MQbbIQRV62PwcZnmvxCHzay";
    this.secretKey = process.env.SUMSUB_SECRET_KEY || "4R55De84jD6mvi6HcVv5g3rq7v7x3MXg";
  }
  ...
  async createAccessToken(externalUserId: string, levelName: string = 'basic-kyc') {
