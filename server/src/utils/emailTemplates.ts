...
/**
 * Template for login verification code
 */
export const loginVerificationTemplate = (
  code: string,
  brandColor: string = '#2563EB'
) => ({
  subject: 'Your Login Verification Code',
  text: `Your login verification code is: ${code}. This code will expire in 10 minutes. If you didn't request this code, please ignore this email.`,
  html: `
    <html><head><style>
      body, html { margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4; color: #333333; }
      .container { max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 8px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); }
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <p>You requested a verification code to log in to your account. Please use the code below:</p>
